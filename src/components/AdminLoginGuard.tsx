      ...
      <div className="bg-white rounded-3xl shadow-xl border border-neutral-200/90 overflow-hidden">
        ...
        <div className="p-6 sm:p-8 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 px-4 bg-emerald-700 hover:bg-emerald-600 active:bg-emerald-800 text-white rounded-2xl font-bold text-sm shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-3 disabled:opacity-60 cursor-pointer"
          >
            {loading ? (
